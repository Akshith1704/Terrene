      ...
      <div className="footer-meta">
        <div className="container footer-meta-header">
          <div className="footer-meta-col">
            <div className="footer-meta-block">
              ...
              <Copy delay={0.2}>
                <h2>Briefs made structured, thoughtful, actionable.</h2>
              </Copy>
            </div>
          </div>
          <div className="footer-meta-col">
        ...
        <div className="container footer-socials">
          ...
          <div className="footer-meta-col">
            <Copy delay={0.1}>
              <p>
                We believe great architecture begins not with decoration, but with
                the quiet clarity of a shared brief.
              </p>
            </Copy>
          </div>
        </div>
