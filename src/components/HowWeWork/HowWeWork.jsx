    ...
    <div className="how-we-work" ref={containerRef}>
        ...
        <div className="container">
          <div className="how-we-work-header-content">
            <div className="how-we-work-header-callout">
              <Copy delay={0.1}>
                <p>The Briefing Workflow</p>
              </Copy>
            </div>
            <Copy delay={0.15}>
              <h3>
                From initial client intake to executable spatial brief in four structured steps
              </h3>
            </Copy>
      ...
      <div className="how-we-work-col how-we-work-cards" ref={cardsRef}>
        <div className="how-we-work-card">
          ...
          <div className="how-we-work-card-copy">
            <div className="how-we-work-card-index-label">
              <h3>Intake / Lifestyle Context</h3>
            </div>
            <p className="md">
              Clients complete a guided visual intake. Daily routines, natural
              sunlight orientation, and occupancy habits establish the project's
              baseline parameters.
            </p>
          </div>
        </div>
        <div className="how-we-work-card">
          ...
          <div className="how-we-work-card-copy">
            <div className="how-we-work-card-index-label">
              <h3>Taxonomy / Material Intent</h3>
            </div>
            <p className="md">
              Replace disorganized mood boards with calibrated light temperatures,
              tactile surface palettes, and acoustic expectations selected from
              our architectural taxonomy.
            </p>
          </div>
        </div>
        <div className="how-we-work-card">
          ...
          <div className="how-we-work-card-copy">
            <div className="how-we-work-card-index-label">
              <h3>Spatial Flow / Ratios</h3>
            </div>
            <p className="md">
              Establish room thresholds, volumetric proportions, and sightline
              intent before schematic design, ensuring layout decisions are
        ...
        <div className="how-we-work-card">
          ...
          <div className="how-we-work-card-copy">
            <div className="how-we-work-card-index-label">
              <h3>The Living Brief / Signoff</h3>
            </div>
            <p className="md">
              Generate a unified, living spatial brief doc that clients and
              studios sign off on. Export straight into your studio's CAD and BIM
              workflows with zero ambiguity.
            </p>
          </div>
        </div>
      </div>
